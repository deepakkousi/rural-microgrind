          ...
          <div key={rec.recommendation_id} className="bg-slate-900 border border-slate-800 rounded-xl p-6 shadow-md">
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-800 pb-3 mb-4">
              ...
              <div className="flex items-center space-x-3 text-xs font-mono">
                ...
                <span className="text-slate-400">Confidence: <strong className="text-sky-400">{(rec.confidence * 100).toFixed(0)}%</strong></span>
            ...
            <div className="bg-slate-800/40 p-4 rounded-lg border border-slate-700/60 mb-4">
              ...
              <p className="text-xs text-slate-400 font-mono bg-slate-950 p-2 rounded border border-slate-800">
                Evidence Context: {rec.evidence.context} (Observed: {rec.evidence.observed_value} kW vs Expected: {rec.evidence.expected_value} kW)
              </p>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pt-2">
              <div className="flex items-center space-x-6 text-sm font-mono">
                <div>
                  <span className="text-xs text-slate-400 block">Est. Energy Saving</span>
                  <span className="text-sky-400 font-bold">{rec.estimated_energy_saving_kwh} kWh/mo</span>
                </div>
                <div>
